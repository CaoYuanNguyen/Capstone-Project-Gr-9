...
//     // b15b: scroll xuống từ từ, dừng trước footer 100px
...
//                 const distance = 300
//                 const delay = 400
//                 const stopBefore = 100 // dừng trước footer 100px

//                 const timer = setInterval(() => {
//                     const maxScroll = document.body.scrollHeight - window.innerHeight - stopBefore
                    
//                     window.scrollBy(0, distance)
//                     currentPos += distance

//                     if (currentPos >= maxScroll) {
//                         window.scrollTo(0, maxScroll) // scroll đúng vị trí dừng
//                         clearInterval(timer)
//                         resolve()
//                     }
//                 }, delay)
...
export class LichSuDatPhongPage extends BasePage {
    readonly userMenuButton: Locator
    readonly dashboardButton: Locator
    readonly phongDaThue: Locator
